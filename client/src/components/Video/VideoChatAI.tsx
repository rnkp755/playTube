...
const VideoChatAI: React.FC<VideoChatAIProps> = ({
	videoId,
	onTimestampClick,
}) => {
	const [messages, setMessages] = useState<ChatMessage[]>([
		{
			...
			role: "assistant",
			content:
				"Hi there! I can answer questions about this video. What would you like to know?",
		},
	]);
	...
	const handleSendMessage = async (e?: React.FormEvent) => {
		...
		try {
			// Get AI response
			const response = await videoService.chatWithAI(
				videoId,
				inputMessage
			);
