...
const Signup: React.FC = () => {
  ...
  const handleAvatarSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (file.size > 5 * 1024 * 1024) { // 5MB limit
        setErrors(prev => ({ ...prev, avatar: 'Image file size must be less than 5MB' }));
        return;
      }
  ...
  const handleCoverSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (file.size > 5 * 1024 * 1024) { // 5MB limit
        setErrors(prev => ({ ...prev, coverImage: 'Image file size must be less than 5MB' }));
        return;
      }
      ...
      <div className="card w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            {errors.avatar && <p className="mt-1 text-sm text-error">{errors.avatar}</p>}
          </div>
          ...
          <div className="mb-6">
            ...
            {errors.coverImage && <p className="mt-1 text-sm text-error">{errors.coverImage}</p>}
          </div>
